...
import upsilon.node.configuration.xml.XmlConfigurationLoader.ConfigStatus;
...
public class Index {
	...
	public static class InternalStatus {
		...
		@XmlElementWrapper
		public Collection<ConfigStatus> getConfigStatus() {
			return Main.instance.getConfigurationLoader().getStatuses();
		}
	...
	public Response peerUpdate() {
		...
		final String htmlFile = "Peer update queued.";
