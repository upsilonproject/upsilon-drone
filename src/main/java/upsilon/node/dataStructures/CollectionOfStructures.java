...
public class CollectionOfStructures<T extends ConfigStructure> implements Iterable<T> {
	...
	private T constructElement(final ConfigurationNode<?> newElement) throws Exception {
		ConfigStructure s;
	...
	public Vector<String> getIdsWithSource(final String source) {
	...
	public CollectionAlterationTransaction<T> newTransaction(final String source) {
	...
	public void processTransaction(final CollectionAlterationTransaction<?> cat) {
		...
		synchronized (this.collection) {
			...
			for (final Entry<String, ConfigurationNode<?>> newStructure : cat.getNew().entrySet()) {
			...
			for (final Entry<String, ConfigurationNode<?>> updStructure : cat.getUpdated().entrySet()) {
